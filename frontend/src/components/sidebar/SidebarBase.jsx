...
import { BrainCircuit, X, Settings, LogOut } from 'lucide-react';
...
const SidebarBase = ({ navItems, isOpen, toggleSidebar }) => {
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-72 bg-[var(--bg-main)]/50 backdrop-blur-xl
        border-r border-white/10 transition-transform duration-300 lg:relative lg:translate-x-0
      ...
      >
        <div className="flex flex-col h-full p-6">
          ...
          <div className="pt-4 border-t border-white/10">
            <button className="flex items-center gap-3 w-full p-3 text-slate-400 hover:bg-white/5 rounded-xl">
              <Settings size={20} />
