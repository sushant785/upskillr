...
const Enrollments = () => {
    ...
    if(loading) {
        return (
            <div className='flex h-[50vh] w-full items-center justify-center bg-[var(--bg-main)] text-emerald-500'>
  ...
  return (
    <div className="p-6 md:p-10 font-['Poppins'] text-[var(--text-main)] bg-[var(--bg-main)] min-h-screen transition-colors duration-300">
      ...
      {/* --- EMPTY STATE --- */}
      {learners.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 bg-[var(--bg-card)] border border-[var(--border-subtle)] rounded-3xl text-center shadow-sm">
        ...
        <div className="flex flex-col gap-4 mb-6"> {/* Wrapped in a div for spacing */}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-between items-center bg-[var(--bg-card)] p-4 rounded-xl border border-[var(--border-subtle)] shadow-sm">
